...
export default function RegisterForm() {
  ...
  return (
    ...
    className='flex flex-col gap-2 justify-center py-4 px-3 rounded-lg bg-white'>
        ...
        <button type='submit'
          className='flex disabled items-center gap-1 bg-transparent hover:bg-blue-500 text-blue-700 hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded flex justify-center'>
